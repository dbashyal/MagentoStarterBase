<?php
class Netlogiq_AddRemoveLink_Helper_Data extends Mage_Core_Helper_Abstract {
	/**
	...
	public function categoryAttribute($category, $attributeHtml, $attributeName) {
		...
		$attributeHtml = $this -> process('categoryAttribute', $attributeHtml, array('category' => $category, 'attribute' => $attributeName));
		return $attributeHtml;
	}
