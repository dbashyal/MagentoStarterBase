...
class Technooze_Tnav_Block_Adminhtml_Tnav_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('form_section_categories', array(
            'label'     => Mage::helper('tnav')->__('Child Categories'),
            'title'     => Mage::helper('tnav')->__('Child Categories'),
            'content'   => $this->getLayout()->createBlock('tnav/adminhtml_catalog_category_tab_form')->toHtml(),
        ));
