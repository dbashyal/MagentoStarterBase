<?php
class Technooze_Brands_Block_Result extends Mage_Catalog_Block_Product_List
{
  ...
  protected function _getProductCollection()
  {
    ...
    if (is_null($this->_productCollection)) {
      ...
      $_filters = Mage::getSingleton('Technooze_Brands/Layer')->getState()->getFilters();
      ...
      Mage::getSingleton('Technooze_Brands/Layer')->setProductCollection($this->_productCollection);
    }
